...
export default function SignUpFullStack() {
    const [useregister, setuseregister] = useState({ fname: "", lname: "", gender: "", city: "", state: "", email: "", password : "", cpassword : "" })
    ...
    const check_err = (e) => {
        ...
        if (useregister.password == "") {
            errors.password = "Please Enter Your Password"
        }
        if (useregister.cpassword == "") {
            errors.cpassword = "Please Confirm Your Password"
        }

        if(useregister.password!=useregister.cpassword){
        ...
        if (Object.keys(errors).length === 0) {
            ...
            const body = {
                ...
                cpassword: useregister?.cpassword
            };
            if (edit) {
                axios.put(`http://localhost:3000/update/${editData}`, body).then((response) => {
                    console.log("RESP : ", response)
                    setedit(false)
                    setuseregister({ fname: "", lname: "", gender: "", city: "", state: "", email: "", password: "", cpassword : "" })
                    userList();
                })
                    ...
                    <form onSubmit={check_err}>
                        ...
                        <div class="form-main">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="subject-input">
                                        <input type="password" name='password' value={useregister.password} onChange={getInput} placeholder="Enter Your Password" />
                                        <span>{err.password}</span>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="subject-input">
                                        <input type="password" name='cpassword' value={useregister.cpassword} onChange={getInput} placeholder="Confirm Password" />
